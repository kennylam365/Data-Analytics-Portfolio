...
This is a capstone project done by me for my google Data Analytics Project. The data used in this capstone project is from <https://divvy-tripdata.s3.amazonaws.com/index.html>.
...
q3_2019 <- read_csv("Divvy_Trips_2019_Q2.csv")
q4_2019 <- read_csv("Divvy_Trips_2019_Q2.csv")
q1_2020 <- read_csv("Divvy_Trips_2020_Q1.csv")
```

### Wrangle and merging raw data

As the data we are looking at is for the year 2019, we need to merge the q1-q4 2019 raw data before we begin our analysis. We start by renaming the columns to ensure that we can combine the raw data into a single file.
...
write.csv(Cyclistic_Data_Count, file = "C:/Users/Kenny/Documents/Trips Google DA/avg_ride_length.csv")
write.csv(Cyclistic_Data_v2, file = "C:/Users/Kenny/Documents/Trips Google DA/cyclistic_cleaned_data.csv")